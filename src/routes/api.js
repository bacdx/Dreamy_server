...
router.get("/sanphams",ApiController.getSanPhams) //  http://localhost:3000/api/san_phams
router.get("/sanpham",ApiController.getSanPham); //  http://localhost:3000/api/san_pham
router.get("/colors",ApiController.getColorbyMaSanPham)// can truyen ma sp vd http://localhost:3000/api/colors?masp=8
router.get("/sizes",ApiController.getSizeByMaSanPham)// can truyen ma sp vd http://localhost:3000/api/size?masp=7
router.get("/comments",ApiController.getCommentsByMaSanPham)// can truyen masp vd http://localhost:3000/api/comments?masanpham=7
